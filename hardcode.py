...
async def main():
    global score
    await motor_pair.move_for_time(motor_pair.PAIR_1, 3460, 0, velocity=360) # up to first gs
    ...
    await motor_pair.move_for_time(motor_pair.PAIR_1, 1829, 0, velocity=360) # to fourth gs
