...
async def main():
    await motor_pair.move_for_time(motor_pair.PAIR_1, 2076, 0, velocity=360) # up to first can
    await motor.run_for_time(port.E, 2000, velocity=360) # knock over can
    await runloop.sleep_ms(1200) # remove can
    await motor_pair.move_for_time(motor_pair.PAIR_1, 1384, 0, velocity=360) # up to first gs
    await light_matrix.write('1')
    await motor_pair.move_for_time(motor_pair.PAIR_1, 1024, 0, velocity=360) # up to middle of first circle
    await motor.run_for_time(port.E, 2000, velocity=360) # knock over can
    await runloop.sleep_ms(1200) # remove can
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 200, 90, velocity = 200) # turn 90 degrees
    await motor_pair.move_for_time(motor_pair.PAIR_1, 990, 0, velocity=360) # to second gs
    await light_matrix.write('2')
    await motor_pair.move_for_time(motor_pair.PAIR_1, 3954, 0, velocity=360) # to third gs
    await light_matrix.write('3')
    await motor_pair.move_for_time(motor_pair.PAIR_1, 929, 0, velocity=360) # to third can 
    await motor.run_for_time(port.E, 2000, velocity=360) # knock over can
    await runloop.sleep_ms(1200) # remove can
    await motor_pair.move_for_time(motor_pair.PAIR_1, 900, 0, velocity=360) # to fourth gs
    ...
    await motor.run_for_time(port.E, 2000, velocity=360) # knock over can
    await runloop.sleep_ms(1200) # remove can
    await motor_pair.move_for_time(motor_pair.PAIR_1, 2228, 0, velocity=360) # to duck
    await sound.play('Squeaky Toy')
    ...
    await motor.run_for_time(port.E, 2000, velocity=360) # knock over can
    await runloop.sleep_ms(1200) # remove can
    await motor_pair.move_for_time(motor_pair.PAIR_1, 1000, 0, velocity=360) # up to 8th gs
